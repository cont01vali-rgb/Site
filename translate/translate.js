        ...
        return {
            'ro': {
                ...
                "home": {
                    ...
                    "start_race": "Începe Cursa",
                    "race_subtitle": "F1 Racing cu Germana",
                ...
                "numbers": {
                    "page_title": "Die Zahlen (0-9999) - Numerele germane",
                    "test_title": "Test: Numerele în Germană (0-9999)",
                    "test_button": "Începe testul pentru numere 📖",
                    ...
                    "fill_instruction": "Scrie numărul în germană:",
                    "audio_instruction": "Ascultă numărul și scrie cifra:",
                    "mc_instruction": "Alege forma corectă în germană:",
                    "play_audio": "Redă audio",
                    "play_again": "Redă din nou",
                    ...
                    "test_duration": "Durata testului",
                    "excellent_result": "Excelent! Stăpânești foarte bine numerele germane!",
                    "good_result": "Foarte bine! Ai o înțelegere bună a numerelor.",
                    "okay_result": "Bine făcut! Cu puțină practică vei fi și mai bun.",
                    "needs_improvement": "Nu e rău! Repetă lecția și încearcă din nou.",
                    "retry_test": "Repetă testul"
                }
            },
            'en': {
                "nav": {
                ...
                "home": {
                    ...
                    "race_subtitle": "F1 Racing with German",
                ...
                "numbers": {
                    "page_title": "Die Zahlen (0-9999) - German Numbers",
                    "test_title": "Test: German Numbers (0-9999)",
                    "test_button": "Start the numbers test 📖",
                    "progress_text": "Question",
                    "score_text": "Score",
                    "verify_button": "Check", 
                    "next_button": "Next question",
                    "back_to_lesson": "← Back to lesson",
                    "fill_in_title": "Fill in the number in German",
                    "audio_title": "Listen and write the number",
                    "multiple_choice_title": "Choose the correct answer",
                    "fill_instruction": "Write the number in German:",
                    "audio_instruction": "Listen to the number and write the digit:",
                    "mc_instruction": "Choose the correct form in German:",
                    ...
                    "excellent_result": "Excellent! You master German numbers very well!",
                    "good_result": "Very good! You have a good understanding of numbers.",
                    "okay_result": "Well done! With a little practice you'll be even better.",
                    "needs_improvement": "Not bad! Review the lesson and try again.",
            ...
            'ua': {
                ...
                "home": {
                    ...
                    "continue_subtitle": "Das deutsche Alphabet",
                    "start_race": "Почати гонку",
                    "race_subtitle": "F1 гонки з німецькою",
                ...
                "numbers": {
                    "page_title": "Die Zahlen (0-9999) - Німецькі числівники",
                    "test_title": "Тест: Німецькі числівники (0-9999)",
                    "test_button": "Почати тест з числівників 📖",
                    "progress_text": "Питання",
                    "score_text": "Бали",
                    "verify_button": "Перевірити", 
                    "next_button": "Наступне питання",
                    "back_to_lesson": "← Повернутися до уроку",
                    "fill_in_title": "Заповни число німецькою",
                    "audio_title": "Прослухай і напиши число",
                    "multiple_choice_title": "Обери правильну відповідь",
                    "fill_instruction": "Напиши число німецькою:",
                    "audio_instruction": "Прослухай число і напиши цифру:",
                    "mc_instruction": "Обери правильну форму німецькою:",
                    "play_audio": "Відтворити аудіо",
                    "play_again": "Відтворити знову",
                    "correct_answer": "Чудово! Правильна відповідь!",
                    "wrong_answer": "Неправильно. Спробуй ще раз!",
                    "correct_answer_was": "Правильна відповідь була",
                    "explanation": "Пояснення",
                    "rule": "Правило",
                    "test_completed": "Тест завершено!",
                    "final_score": "Підсумковий рахунок",
                    "test_duration": "Тривалість тесту",
                    "excellent_result": "Відмінно! Ти дуже добре знаєш німецькі числівники!",
                    "good_result": "Дуже добре! У тебе гарне розуміння чисел.",
                    "okay_result": "Добре зроблено! З невеликою практикою будеш ще кращим.",
                    "needs_improvement": "Непогано! Повтори урок і спробуй знову.",
